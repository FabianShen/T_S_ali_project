...
load data
load('China city MRIO.mat');
C = xlsread(['MRIO2017_42 CEADS'],['Table_2017_consistent'],'D5:AXE1306')
D1314
AXE1314
%}
...
% for i =1:31
%     for j = 1:42
%         footprint_product_refined(i,j) = sum(footprint_product(i,(j*31-30):j*31));
%     end
% end
